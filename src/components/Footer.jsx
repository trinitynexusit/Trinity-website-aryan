      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center gap-2.5 mb-5">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[#06b6d4] font-bold text-xs tracking-widest">NEXUS TECH</span>
              </div>
            </Link>
            ...
            <div className="space-y-2.5">
              ...
              <span className="flex items-start gap-2 text-sm text-gray-500">
                ...
                <span>Assotech Business Cresterra, 1115, Tower 4, Sector 135, Noida (UP), India, 201305</span>
              </span>
            </div>
            <div className="flex items-center gap-3 mt-6">
              <a
                href="https://www.facebook.com/share/17RrCqigEB/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-gray-500 hover:text-[#06b6d4] hover:border-[#06b6d4]/30 transition-all"
                title="Follow us on Facebook"
              >
                <Facebook size={14} />
              </a>
              <a
                href="https://www.linkedin.com/company/trinitynexus/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-gray-500 hover:text-[#06b6d4] hover:border-[#06b6d4]/30 transition-all"
              ...
              <a
                href="https://www.instagram.com/trinitynexusofficial"
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-gray-500 hover:text-[#06b6d4] hover:border-[#06b6d4]/30 transition-all"
        ...
        <div className="mt-14 pt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-gray-600 font-mono">SOC OPERATIONAL — 24x7</span>
          </div>
        </div>
      </div>
    </footer>
